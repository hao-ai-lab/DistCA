...
import torch
from distca.runtime.megatron_patch.model_patch import (
    get_gpt_config,
    get_gpt_layer_with_transformer_engine_spec,
)
from distca.runtime.megatron_patch.packed_seq_params import PingPangSingleStepPackedSeqParams
from distca.runtime.megatron_patch.transformer_layer import (
...
def test_forward(
    ...
    for _ in range(3):
        worker.forward_normal(tensor_shard, packed_seq_params, return_grad=True)
