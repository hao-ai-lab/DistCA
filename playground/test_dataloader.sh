...
export DISTCA_LOG_NSYS_DIR="${DISTCA_LOG_ROOT_DIR}/nsys"
export DISTCA_LOG_RANK_LOGS_DIR="${DISTCA_LOG_ROOT_DIR}/rank_logs"
export DISTCA_LOG_CHECKPOINTS_DIR="${DISTCA_LOG_ROOT_DIR}/checkpoints"
export DISTCA_LOG_TENSORBOARD_DIR="${DISTCA_LOG_ROOT_DIR}/tensorboard"
export DISTCA_LOG_DATA_CACHE_DIR="${DISTCA_LOG_ROOT_DIR}/data_cache"

# Create directories upfront so nsys can write to them
mkdir -p "${DISTCA_LOG_NSYS_DIR}" "${DISTCA_LOG_RANK_LOGS_DIR}" "${DISTCA_LOG_CHECKPOINTS_DIR}" "${DISTCA_LOG_TENSORBOARD_DIR}" "${DISTCA_LOG_DATA_CACHE_DIR}"
