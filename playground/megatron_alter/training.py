...
def get_original_batch_size(args) -> int:
    return mpu.get_data_parallel_world_size() * args.micro_batch_size * get_num_microbatches()
...
def train(
    ...
    while iteration < args.train_iters:
        ...
        print_rank_0("<< Training Step Start")
        (
            loss_dict,
            skipped_iter,
            should_checkpoint,
        ...
        print_rank_0("<< Training Step End")
