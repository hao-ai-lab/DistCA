...
# %%
d2_path       = "../data/20250809_171027_fix_postprocess.2/d2.json"
baseline_path = "../data/20250809_171027_fix_postprocess.2/baseline.json"
output_dir    = "compare_d2_baseline.results.2"
# %%
import json
...
df.to_csv(f"{output_dir}/d2_baseline_comparison.64k.tp8dp2.csv", index=False)
...
df_markdown.to_markdown(f"{output_dir}/d2_baseline_comparison.64k.tp8dp2.md")
...
df2.to_csv(f"{output_dir}/d2_baseline_comparison.64k.tp8dp2.simple.csv", index=False)
df2.to_markdown(f"{output_dir}/d2_baseline_comparison.64k.tp8dp2.simple.md")
