...
# $$OUTPUT_DIR_PREFIX=/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks2/_251025_perseq_pp/logs.v1-n8-prolong-0.3-8B-n32
# $$FOLDER_SEPARATOR=1
# $$EXPERIMENT_DISTS=("prolong 0.3")

# bash /mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks2/_251025_perseq_pp/salloc_srun.pp_8b.v2.sh --config /mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks2/_251025_perseq_pp/perseq_pp-n8-prolong-0.3-8B-n32.sh
