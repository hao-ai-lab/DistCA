 ...
 * for Inter-Node only all2all communication. We do Tensor Parallel for
 * Intra-Node.
 */
...
struct FastA2aDispatchHelper {
  ...
  FastA2aDispatchHelper(int64_t rank, int64_t local_rank, int64_t world_size, int64_t buffer_size)
